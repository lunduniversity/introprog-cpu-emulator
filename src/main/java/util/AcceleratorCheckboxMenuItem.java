 ...
 */
public class AcceleratorCheckboxMenuItem extends JCheckBoxMenuItem {
  ...
  public AcceleratorCheckboxMenuItem(String text) {
    this(text, null);
  }

  public AcceleratorCheckboxMenuItem(String text, KeyStroke keyStroke) {
    super(text);
