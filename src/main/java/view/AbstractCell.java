...
public abstract class AbstractCell extends JPanel {
	...
	private static final Border PC_FOCUS_BORDER = BorderFactory.createLineBorder(Color.CYAN, 1);

	private static final Border PC_NO_FOCUS_BORDER = UIManager.getBorder("TextField.border");
	...
	public void highlight() {
		for (JTextField bit : bits) {
			bit.setBackground(UIManager.getColor("TextField.selectionBackground"));
		}
	}
