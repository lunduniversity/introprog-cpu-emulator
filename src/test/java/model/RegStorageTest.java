...
class RegStorageTest {
  ...
  void testSetAndGetRegisterNames() {
    ...
    registry.setRegister(Registry.REG_R0, 4);
    registry.setRegister(Registry.REG_R1, 5);
    registry.setRegister(Registry.REG_R2, 6);
    ...
    assertEquals(4, registry.getRegister(Registry.REG_R0));
    assertEquals(5, registry.getRegister(Registry.REG_R1));
    assertEquals(6, registry.getRegister(Registry.REG_R2));
