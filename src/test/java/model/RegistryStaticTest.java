...
class RegistryStaticTest {
  ...
  void testIdxToName() {
    ...
    assertEquals(Registry.REG_R0, Registry.idxToName(3));
    assertEquals(Registry.REG_R1, Registry.idxToName(4));
    assertEquals(Registry.REG_R2, Registry.idxToName(5));
  ...
  void testNameToIdx() {
    ...
    assertEquals(3, Registry.nameToIdx(Registry.REG_R0));
    assertEquals(4, Registry.nameToIdx(Registry.REG_R1));
    assertEquals(5, Registry.nameToIdx(Registry.REG_R2));
