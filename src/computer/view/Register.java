...
public class Register extends JPanel {
	 ...
	 * Create the panel.
	 */
	public Register(String name, CellNav cellNav) {
		setBorder(null);
		setLayout(new MigLayout("gap 0, insets 0", "[30px:30px:30px][][100px:100px:100px][][30px:30px:30px][30px:30px:30px]", "[]"));

		JLabel lblIndex = new JLabel(name);
